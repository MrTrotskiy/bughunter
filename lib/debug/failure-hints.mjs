...
// `... firewall-refused request POST /rawcaster/addnuggetview (off-origin) ...`
...
// `reveal step changed route to /viewprofile/xxx — no longer stay-on-page`
...
// along and was simply never read. Measured on run raw1: 38 of 287 acts and 32 of 182 graph
// elements carry an empty name; 12 of those elements resolve to a real authored id (#nugget_video,
...
// `Add GroupuploadCreatesearchConnections (0)No dataNo Connections Found` as if it were a label.
