...
// "firewall-refused", so all 43 REVEAL_FIREWALL acts of run `raw1` were reported as danger-floor
...
// the causally-kept fire and trace writes it. Run `fix1` holds POST /rawcaster/addfriendgroup 500 ×2,
// POST /rawcaster/list_all_paryer_group 500 ×3 and POST /rawcaster/list_ad 422 that no screen showed.
