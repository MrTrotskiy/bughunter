...
export function contextOptions(opts = {}) {
  ...
  // requests, so a SW background-sync POST would be invisible to page-level request observation.
  // Blocking service workers closes that blind spot. Applies at BOTH newContext sites (this is the
