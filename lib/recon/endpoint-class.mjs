...
// `getothersprofile`, `searchrawcasterusers`, `getfaq`, `listevents` is a READ that happens to travel by
...
// Classify one endpoint. Returns 'read' | 'write' | 'telemetry'.
//
...
export function classifyEndpoint({ method = 'GET', url = '', urlPattern = '' } = {}) {
  ...
  return 'write';                                          // an unnamed non-GET: assume it writes, and say so
}
