...
function verdictFor({ name, route, ownership, runCreatedAccount }, floor) {
  ...
  //
  // This closes a measured gap. On another user's content `decide()` returned allow=true for "Report Abuse"
  // and "Block User", classified FOREIGN_ADDITIVE — "creates nothing of theirs to lose". True of a like,
