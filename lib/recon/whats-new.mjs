    ...
    if (opts.actTemplate != null) {
      ...
      try {
        result.acted = await actStep(
          ...
          { fill: opts.fill, capture: runId ? makeCapture(runId, tid) : undefined, revealPath, openerReplayable: opts.openerReplayable, refuseMutations: readOnly, revealOpener: opts.revealOpener },
        );
      } finally {
