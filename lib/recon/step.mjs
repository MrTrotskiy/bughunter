...
import { ownsTarget } from './hunt-gate.mjs';
...
export async function actStep(page, graph, ledger, target, { fill, capture, revealPath, openerReplayable, refuseMutations, revealOpener, statefulProvenance, huntWrites, marker, runCreatedAccount, huntWindow } = {}) {
