...
export async function actStep(page, graph, ledger, target, { fill, capture, revealPath, openerReplayable, refuseMutations, statefulProvenance } = {}) {
  ...
  if (refuseMutations && mutationFloor({ name: gateName, route: gateRoute }) === 'mutation') {
    throw envelopeError({
      code: 'MUTATION_FLOOR',
