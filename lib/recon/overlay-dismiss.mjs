...
export async function clickIntercepted(page, handle) {
  ...
  try {
    return await handle.evaluate((el) => {
      ...
      // element's behalf. This is a common headless-library shape: an open dialog sets `pointer-events: none` on the
...
// another library instead sets `pointer-events: none` on the BODY when a dialog opens — so nothing in
