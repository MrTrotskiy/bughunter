...
export async function clickIntercepted(page, handle) {
  ...
  try {
    return await handle.evaluate((el) => {
      ...
      if (!top) return false;
      // The hit is ours if the topmost element is the target, inside it, or an ancestor of it (a wrapper
      // receiving the click on the target's behalf is the normal case, not an interception).
