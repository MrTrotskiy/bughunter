...
# /recon <url>  — slash command (.claude/commands/recon.md): full Phase-1 run — daemon → recon-agent loop until drained → report
...
- .claude/commands/recon.md — /recon <url> run orchestrator: brackets the daemon, loops the recon agent until drained, reports
